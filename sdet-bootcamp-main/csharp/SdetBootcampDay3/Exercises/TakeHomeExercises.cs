...
namespace SdetBootcampDay3.Exercises
{
    ...
    public class TakeHomeExercises
    {
        ...
        */
        [Test]
        public async Task Test_SingleUserName_StatusCodeIsOK()
        {
        ...
        public async Task Test_GetUserName_StatusCodeIsOK(int userId, string expectedName)
        {
         ...
         */
        [Test]
        public async Task Test_NewUserIsPosted_StatusCodeIsCreated()
        {
