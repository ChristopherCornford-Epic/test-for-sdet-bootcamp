namespace SdetBootcampDay2.TestObjects.Exercises
{
    ...
    {
        private IDictionary<OrderItem, int>? _stock;
         ...
         */
        public void ProcessOrder(OrderItem item, int quantity)
        {
        ...
        public bool ProcessPayment(OrderItem item, int quantity)
        {
            this.paymentProcessor.PayFor(item, quantity)
        }
